...
dinov2_ld = torch.hub.load('.', f'{backbone_name}_dd',source="local")
dinov2_ld.eval()
import urllib
...
cv2.imwrite(f"depth_{backbone_name}_dd.png",depth_img[:,:,::-1])

torch.onnx.export(dinov2_ld,batch,f'{backbone_name}_dd.onnx',opset_version=12)